@extends('layout')
@section('title', 'Laporan Data Presensi Guru')
@section('content')
    ...
    <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
                    <div class="tab-pane fade show active" id="pills-home-nobd" role="tabpanel"
                        ...
                        <div class="col-md-12">
                            <form action="/cetaklaporanabsenguru" id="pembayaranForm" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" name="guru_id" id="guru_id" >
                                        <option value="">Pilih Guru</option>
                                        @foreach($guru as $sw)
                                        <option value="{{ $sw->id }}" {{ $req == null ? '' : ($sw->id == $req->guru_id ? "selected" : "") }}>{{ $sw->nama }} ( {{ $sw->nip }} )</option>
                                        @endforeach
                                    </select>
                                </div>
        ...
        <div class="card mb-4 mt-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Table Presensi Guru</h6>
            </div>
            <div class="card-body">
        ...
        <div class="card mb-4 mt-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Diagram Presensi Guru</h6>
            </div>
            <div class="card-body">
                <div class="chart-bar">
