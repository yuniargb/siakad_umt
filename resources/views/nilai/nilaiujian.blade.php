@extends('layout')
@section('title', 'Data Nilai Ujian')
@section('content')
                                            ...
                                            <td>
                                                <div class="row">
                                                    <button type="button" class="btn btn-primary btnNilaiModal"
                                                        ...
                                                        data-method='@method("put")' data-type="ujian"><i
                                                            class="fa fa-edit"></i>
                                                    </button>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="nilaiModalTitle">Tambah Nilai Ujian</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="/nilaiujian" id="nilaiForm" method="post">
                    @csrf
